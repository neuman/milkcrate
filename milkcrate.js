...
MILKCRATE.recommendation = {
    init: function(flagURL) {
        this.flagURL = flagURL;
    },
    // toggle article recommendation flags
    hideArticle: function(id, audience, callback) {
        if ('string' == typeof this.flagURL &&
            'number' == typeof id &&
            'string' == typeof audience) {
            var request = {}
            request[audience] = false
    ...
    hideForContact: function(id, callback) {
        this.hideArticle(id, 'is_contact_active', callback);
    },
    hideForAccount: function(id, callback) {
        this.hideArticle(id, 'is_account_active', callback);
    },
    hideForAll: function(id, callback) {
        this.hideArticle(id, 'is_global_active', callback);
    },
};

MILKCRATE.interest = {
    init: function(addURL, removeURL) {
        this.addURL = addURL;
        this.removeURL = removeURL;
    },
    // remove user's interest
    remove: function(id, callback) {
        if ('string' == typeof this.removeURL &&
            'number' == typeof id) {
    ...
    add: function(topicID, contactID, callback) {
        if ('string' == typeof this.addURL &&
            'number' == typeof topicID &&
            'number' == typeof contactID) {
